...
> 텍스트는 사람마다 다르게 해석할 수 있음을 인지합니다. 본인이 맡은 업무때문에 회의 시간, 스프린트 프로세스를 무시하는 행위를 용납한다는 의미가 아닙니다. 아래에서 언급하지만 커뮤니케이션의 중요도를 가장 높은 순위로 보고 있습니다.

</br>

업무 진행 속도가 늦습니다. 함축해서 언급하자면 설계, 문서화 등 사전 작업을 중요시하기 때문입니다. 문서화는 업무를 진행함에 있어 선택 요소가 아닌 필수 요소라고 생각합니다.
...
`해당 항목은 중요도 순서가 아닌 생각나는 데로 작성하였습니다.`
</br>
...
- 키워드 목록
  - Typescript, GraphQL, MSA, Koajs, Mongo DB, React, React-native, PWA, DevOps

앞으로 이런 일들을 하고 싶습니다.
- 레거시(모노리틱) 프로젝트의 운영 환경을 컨테이너 기반 운영 환경으로 이전
  - Micro service architecture, Serverless 등
  - 스프링 기반의 프로젝트보단 도메인 기반의 프로젝트(dJango, Express 등) 선호
  - 기존 운영 환경 기반으로 운영하면서 도메인 단위로 기능 추가
    - [배민 API GATEWAY - spring cloud zuul 적용기](http://woowabros.github.io/r&d/2017/06/13/apigateway.html)
- 도메인 단위의 프로젝트 개발
- 병목 현상의 발견, 수정 및 솔루션 도입

이런 일들은 [지양](https://namu.wiki/w/%EC%A7%80%EC%96%91%EA%B3%BC%20%EC%A7%80%ED%96%A5)합니다.
- 웹 UI를 포함한 프론트엔드 개발
  - 풀스택 엔지니어의 업무를 진행하며 실보다 득이 많다는 것을 알게된 후로 업무의 선택, 집중을 하려합니다.
  - 컴포넌트 기반의 개발 방식에 관심은 많지만 익숙하진 않습니다.
  - CSS의 충분한 이해와 구현의 어려움을 알고 있습니다.
  - **간단히 해주세요**의 내포된 무게를 알고 있습니다.
- 기획단계의 참여
  - 사업은 소수의 천재가 우직하게 밀고 나가는 것이라고 생각합니다. 각 분야의 전문가들이 비즈니스 구현을 위한 기술적 서포트를 하는 것이 팀플레이라고 생각합니다. ~~백지장을 맞대면 두꺼운 종이가 됩니다~~
  - 해당 비즈니스의 오너는 대표이며, 기술 스택의 오너가 되고 싶습니다.

</br>

`이직하게 되면 비활성화 될 문단입니다.`</br>
현재 구직중입니다. 구직을 위해 해당 문서를 공유할 예정입니다. 해당 문서를 확인하신 담당자 분께서 문서의 어조, 내용에 당황하셨다면 저와 맞지 않음을 느끼신 것이기에 과감히 무시하셔도 좋습니다. 

이직하게 되면 4번째 회사, 5년차의 시작이 됩니다. 많은 경험은 아니지만 그렇다고 적은 경험은 아니라고 생각합니다. 지금까지 회사 생활을 시작하거나 옮겨야할 때 생각한 가장 큰 가치는 **내가 얼마나 성장할 수 있는가?** 였습니다. 덕분에 좋은 사람들을 만나고 다양한 환경에서 경험을 쌓을 수 있었습니다. 시간이 지나면서 추구하는 가치가 바뀌었습니다.
> 잘하고 좋아하는 일을 집중해서 하자.

다양한 업무를 맡아 진행하는 것을 좋아했습니다. 실력은 많이 늘게 되었지만, 시간과 사람에 쫓겨 자신을 옥죄는 시간이 많아졌습니다. 스스로가 지치게 되니 **잘하고 좋아하는 일**을 진행하는 것도 전보다 지치고 흥미가 떨어지는 것을 느꼈습니다. 새로운 업무를 기피한다는 뜻은 아닙니다. 다만 능력의 효율을 극대화하여 최고의 성과를 내고 싶은 욕심이 있습니다. 인력 리소스가 부족하여 하고 싶지 않은 업무를 맡을 수 밖에 없는 환경은 당분간 지양하고 싶습니다.

팀원을 구인하기 위한 인터뷰 혹은 제가 해당 팀원이 되기 위한 인터뷰를 진행하면서 짧으면 10분, 길어야 1~2시간 정도 되는 프로세스의 부조리함을 느꼈습니다. 스피킹 능력과 업무 능력이 비례하지 않으며, 인터뷰를 진행하는 짧은 시간동안 어떤 사람인지 판단한다는 것 자체가 아이러니하다고 생각했습니다. 그런 생각에 의해 제 생각을 미리 전달할 수 있는 매개체로써 작성하였습니다. 읽어주셔서 감사드리며 더 궁금하신 사항은 인터뷰 때 질문 바랍니다.

</br> -->

## 경력사항
### AJ Networks (2016~2018)
#### 아키텍처팀 
...
### 강연, 발표
- 패스트캠퍼스 [**DevOps 구축 BOOTCAMP**](http://www.fastcampus.co.kr/dev_camp_devb/) 강사
