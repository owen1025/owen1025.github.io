...
- 레거시(모노리틱) 프로젝트의 운영 환경을 컨테이너 기반 운영 환경으로 이전
  ...
  - 기존 운영 환경을 기반으로 운영하면서 도메인 단위로 기능 추가
...
이직하게 되면 4번째 회사, 5년차의 시작이 됩니다. 많은 경험은 아니지만 그렇다고 적은 경험은 아니라고 생각합니다. 지금까지 회사 생활을 시작하거나 옮겨야할 때 생각한 가장 큰 가치는 **내가 얼마나 성장할 수 있는가?** 였습니다. 
